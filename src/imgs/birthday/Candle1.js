  ...
  return (
    <div className="candle-1">
      ...
      <svg className="candle" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <path filter='url(#candle-shadow)' d="M 26.998 21.157 L 64.879 6.95 L 63.422 79.169 L 77.991 88.64 C 61.478 92.214 43.944 90.957 28.455 85.088 L 43.024 76.801 L 44.481 23.525 L 26.998 21.157 Z" fill='#fffffa' stroke='#b00' strokeWidth={4} strokeLinejoin="round"></path>
